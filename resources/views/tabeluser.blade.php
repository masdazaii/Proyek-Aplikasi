                        	...
                        	<form action="{{route('update', $data->admin_id)}}" method="POST">
	                            <div class="row clearfix">
	                                <div class="col-sm-12">
	                                    ...
	                                    <div class="form-group">
	                                        <div class="form-line">
	                                            <input type="text" class="form-control" placeholder="Admin Id" name="admin_id"  value="{{$data->admin_id}}" />
	                                        </div>
	                                    </div>
	                                    <div class="form-group">
	                                        <div class="form-line">
	                                    ...
	                                    <div class="form-group">
	                                        <div class="form-line">
	                                            <input type="text" class="form-control" placeholder="Jenis Kelamin" name="jenisKelamin" value="{{$data->jenisKelamin}}"/>
	                                        </div>
	                                    </div>
	                                    <div class="form-group">
	                                        <div class="form-line">
	                                            <input type="text" class="form-control" placeholder="Nomor Telefon" name="NoHp" value="{{$data->NoHp}}"/>
	                                        </div>
	                                    </div>
	                                </div>
	                                    {{csrf_field()}}
